...
def main():
    ...
    results = train_and_evaluate_models(
        ...
        epochs=20,  # Уменьшаем количество эпох, так как используем early stopping
        batch_size=64,  # Увеличиваем размер батча для ускорения
        max_files=15,  # Ограничиваем количество файлов для оптимальной производительности
        validation_split=0.15  # Уменьшаем размер валидационного набора
    )
